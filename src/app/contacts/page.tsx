...
import { ArrowLeft, Users, Plus, Mail, Building, Phone, Tag } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans p-4 space-y-4 select-none">
      ...
      <header className="glass-surface px-6 py-3.5 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2.5">
            ...
            <h1 className="font-extrabold text-sm text-slate-900 tracking-tight">DocMail Contacts</h1>
          </div>
        </div>

        <button
          onClick={() => setShowAddModal(true)}
          className="rose-glow-btn px-4 py-2 text-xs font-bold uppercase tracking-wider flex items-center space-x-1.5 cursor-pointer shadow-md"
        >
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full">
        {contacts.length === 0 ? (
          <div className="glass-surface p-12 text-center space-y-4 my-8 max-w-md mx-auto">
            ...
            {contacts.map((c) => (
              ...
              >
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-pink-300 to-rose-400 flex items-center justify-center font-black text-white text-sm shadow-[0_0_12px_rgba(244,114,182,0.4)]">
                ...
                <div className="space-y-1.5 text-xs text-slate-600 pt-2 border-t border-white/60">
                  {c.company && (
